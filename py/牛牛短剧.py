...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "都市@%E9%", "type_name": "集多🌠都市"},
                            {"type_id": "反转@%E5%", "type_name": "集多🌠反转"},
                            {"type_id": "萌宝@%E8%", "type_name": "集多🌠萌宝"},
                            {"type_id": "古装@%E5%", "type_name": "集多🌠古装"},
                            {"type_id": "逆袭@%E9%", "type_name": "集多🌠逆袭"},
                            {"type_id": "喜剧@%E5%", "type_name": "集多🌠喜剧"},
                            {"type_id": "闪婚@%E9%", "type_name": "集多🌠闪婚"},
                            {"type_id": "王妃@%E7%", "type_name": "集多🌠王妃"},
                            {"type_id": "校园@%E6%", "type_name": "集多🌠校园"},
                            {"type_id": "民国@%E6%", "type_name": "集多🌠民国"},
                            {"type_id": "年代@%E5%", "type_name": "集多🌠年代"},
                            {"type_id": "脑洞@%E8%", "type_name": "集多🌠脑洞"},
                            {"type_id": "总裁@%E6%", "type_name": "集多🌠总裁"}],
                 }
    ...
    def process_video_data(self, detail):
        ...
        for vod in js:
            ...
            video = {
                ...
                "vod_name": name,
                "vod_pic": pic,
                "vod_remarks": '集多▶️' + '️豆瓣评分' + remark + '分'
                    }
            videos.append(video)
        return videos
    ...
    def detailContent(self, ids):
        ...
        content = '请不要相信任何广告！！！祝您观影愉快！集多为您介绍剧情👉-' + detail['data']['vod_content']
